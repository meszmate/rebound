...
;(function (R) {
  ...
  function mountAnchor(ctx) {
    ...
    // Home widget: the nine tiles are solid accent, styled entirely in home.css
    // (see ".rb-home-widget .rb-anchor-dot"), with each cell's position mark
    // drawn from the box edges. The full tool keeps its own components.css look.
