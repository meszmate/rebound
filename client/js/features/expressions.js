...
;(function (R) {
  ...
  var BUILTIN = [
    ...
    { id: 'recoil-overshoot', name: 'Overshoot (velocity)', category: 'physics', desc: 'Apple-style velocity-driven overshoot after each keyframe', code: code(
      'n = 0;',
      'if (numKeys > 0) {',
      '  n = nearestKey(time).index;',
      '  if (key(n).time > time) { n--; }',
